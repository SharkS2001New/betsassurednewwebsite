...
<main class="container">
    <h1 class="page-hero-title">Free Football Betting Tips Today</h1>

    <?php include_once BASE_PATH . "/components/includes/scrollable-nav.inc.php"; ?>

    <div class="section-title-bar">
        <h2>Today's Betting Tips</h2>
        <span class="today-date-tag"><?php echo date('D, d M Y'); ?></span>
    </div>

    <p style="color: #4b5563; margin-bottom: 20px;">
        Explore our <strong>free football betting tips</strong> for today, including <strong>1X2 predictions</strong>, <strong>double chance picks</strong>, and <strong>over/under football tips</strong>. Each match includes probability ratings, odds insight, and expert analysis to help you make smarter betting decisions.
    </p>

...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-42EFLDFS3S"></script>
<script src="https://analytics.ahrefs.com/analytics.js" data-key="ovIosLcoEOoUgg04FH7O/A" async></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-42EFLDFS3S');
</script>
